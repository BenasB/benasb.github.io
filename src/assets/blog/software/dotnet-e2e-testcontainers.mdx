...
Let's tackle a more complex scenario. Alongside .NET services we can add some infrastructure components. This scenario models a blogging application. Below is a diagram depicting data flow in this scenario.
